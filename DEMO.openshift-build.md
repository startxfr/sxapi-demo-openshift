...
This demo provide an [all-in-one ephemeral template](https://raw.githubusercontent.com/startxfr/sxapi-demo-openshift/master/openshift-build-all-ephemeral.json)
...
oc process -f https://raw.githubusercontent.com/startxfr/sxapi-demo-openshift/master/openshift-build-all-ephemeral.json \
           -v SOURCE_BRANCH=master \
           -v DEMO_API=api-demo-api.openshift.demo.startx.fr \
           -v MYSQL_USER="master-user" \
           -v MYSQL_PASSWORD="master-pwd123" \
...
- [build database template](https://raw.githubusercontent.com/startxfr/sxapi-demo-openshift/master/openshift-build-db-ephemeral.json),
- [build api template](https://raw.githubusercontent.com/startxfr/sxapi-demo-openshift/master/openshift-build-api.json) and
- [build www template](https://raw.githubusercontent.com/startxfr/sxapi-demo-openshift/master/openshift-build-www.json)

You can create and use theses templates running the following commands

```bash
# Create database component objects
oc process -f https://raw.githubusercontent.com/startxfr/sxapi-demo-openshift/master/openshift-build-db-ephemeral.json \
           -v SOURCE_BRANCH=master \
           -v MYSQL_USER="master-user" \
           -v MYSQL_PASSWORD="master-pwd123" \
           -v MYSQL_DATABASE="demo" | \
...
oc process -f https://raw.githubusercontent.com/startxfr/sxapi-demo-openshift/master/openshift-build-api.json \
           -v SOURCE_BRANCH=master \
           -v MYSQL_USER="master-user" \
           -v MYSQL_PASSWORD="master-pwd123" \
           -v MYSQL_DATABASE="demo" | \
...
oc process -f https://raw.githubusercontent.com/startxfr/sxapi-demo-openshift/master/openshift-build-www.json \
           -v SOURCE_BRANCH=master \
